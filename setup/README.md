...
3. **Set Cloudflare Worker URL in mainframe:**
   After deployment, update the Worker URL in `mainframe.py` if needed. The default Worker endpoint is:
   ```
   https://broken-boat-ed6e.multitool-43.workers.dev
   ```

4. **Configure Discord Webhooks (optional):**
   The Vercel serverless function reads webhook URLs from Cloudflare Worker environment variables (`DISCORD_WEBHOOK_URL`, `DISCORD_BAN_WEBHOOK_URL`, `DISCORD_WHITELIST_WEBHOOK_URL`). These are configured in your Cloudflare Worker dashboard — not in the Vercel project.

5. **Verify deployment:**
   Open the deployed URL in a browser. You should see the tracking GIF. Any visit will be logged and posted to your Discord webhook.
...
1. [Quick Setup Tutorial](#quick-setup-tutorial)
2. [Repository Topics (Tags)](#repository-topics-tags)
3. [Overview](#overview)
4. [How to Support / Boost Social Signals](#how-to-support--boost-social-signals)
5. [Architecture](#architecture)
6. [Installation](#installation)
7. [Main System Directory Core](#main-system-directory-core)
8. [Sub-Directory 01 — Network Infrastructure & Endpoint Recon](#sub-directory-01--network-infrastructure--endpoint-recon)
9. [Sub-Directory 02 — External OSINT & Target Record Profilers](#sub-directory-02--external-osint--target-record-profilers)
10. [Sub-Directory 03 — Local Data Traffic, Security Audits & Utilities](#sub-directory-03--local-data-traffic-security-audits--utilities)
11. [Sub-Directory 04 — Advanced Infrastructure Audits & Integrity](#sub-directory-04--advanced-infrastructure-audits--integrity)
12. [Sub-Directory 05 — Attack Vectors, Exploit Frameworks & Defensive Auditing](#sub-directory-05--attack-vectors-exploit-frameworks--defensive-auditing)
13. [Image Logger — Vercel Deployment](#image-logger--vercel-deployment)
14. [Logging & Privacy](#logging--privacy)
15. [Configuration & Customization](#configuration--customization)
16. [UI Themes & Directory Banners](#ui-themes--directory-banners)
